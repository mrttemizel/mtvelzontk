        ...
        <div class="col-lg-12">
            ...
            <div class="card ">
                <div class="card-header align-items-center d-flex">
                    <h4 class="card-title mb-0 flex-grow-1">Eğitim Faliyeti Ekle</h4>
                                    ...
                                    <div>
                                        ...
                                        <select class="form-select" name="kys_olcutu"
                                            ...
                                            @foreach( $data as $datas)
                                                <option value="{{$datas -> id}}">{{$datas -> code_name}}
                                                    - {{$datas -> code_description}}</option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="col-xl-12 col-md-12">
                                    <div>
                                        ...
                                        <input type="text" name="faliyetin_adi" placeholder="Faliyetin Adı"
                                               class="form-control" value="{{ old('faliyetin_adi') }}">
                                        <span class="text-danger">
                                    @error('faliyetin_adi')
                                            {{ $message }}
                                            @enderror
                                ...
                                <div class="col-xl-12 col-md-12">
                                    <div>
                                        ...
                                        <input type="text" name="faliyetin_tipi" placeholder="Faliyetin Tipi"
                                               class="form-control" value="{{ old('faliyetin_tipi') }}">
                                    </div>
                                </div>
                                <!--end col-->
                                <div class="col-xl-12 col-md-12">
                                    <div>
                                        ...
                                        <input type="text" name="is_birligi" placeholder="İş Birliği Yapılan - Ortaklık Kurulan Kurum/Kişi"
                                               class="form-control" value="{{ old('is_birligi') }}">
                                    </div>
                                </div>
                                <!--end col-->
                                <div class="col-xl-12 col-md-12">
                                    <div>
                                        ...
                                        <input type="text" name="faliyetin_butcesi" placeholder="Faliyetin Bütcesi"
                                               class="form-control" value="{{ old('faliyetin_butcesi') }}">
                                    </div>
                                </div>
                                ...
                                <div class="col-xl-12 col-md-12">
                                    <div>
                                        ...
                                        <input type="text" name="hedef_kitlesi" placeholder="Hedef Kitlesi"
                                               class="form-control" value="{{ old('hedef_kitlesi') }}">
                                    </div>
                                </div>
                                <!--end col-->
                                <div class="col-xl-12 col-md-12">
                                    <div>
                                        ...
                                        <input type="text" name="hedef_kitle_sayisi" placeholder="Hedef Kitlenin Sayısı"
                                               class="form-control" value="{{ old('hedef_kitle_sayisi') }}">
                                    </div>
                                </div>
                                <!--end col-->
                                <div class="col-xl-12 col-md-12">
                                    <div>
                                        ...
                                        <input type="text" name="faliyeti_gerceklestiren_personel" placeholder="Faliyeti Gerçekleştiren Personel"
                                               class="form-control" value="{{ old('faliyeti_gerceklestiren_personel') }}">
                                    </div>
                                </div>
                                <!--end col-->
                                <div class="col-xl-12 col-md-12">
                                    <div>
                                        ...
                                        <input type="text" name="faliyetin_kisa_aciklamasi" placeholder="Faliyetin Kısa Açıklaması"
                                               class="form-control" value="{{ old('faliyetin_kisa_aciklamasi') }}">
                                    </div>
                                </div>
                                <!--end col-->
                                <div class="col-xl-12 col-md-12">
                                    <div>
                                        ...
                                        <input type="text" name="temel_alani" placeholder="Temel Alanı"
                                               class="form-control" value="{{ old('temel_alani') }}">
                                    </div>
                                </div>
                                <!--end col-->

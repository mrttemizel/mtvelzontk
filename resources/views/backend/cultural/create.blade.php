        ...
        <div class="col-lg-12">
            ...
            <div class="card ">
                <div class="card-header align-items-center d-flex">
                    <h4 class="card-title mb-0 flex-grow-1">Proje Ekle</h4>
                                ...
                                <div class="col-xl-12 col-md-12">
                                    <div>
                                        ...
                                        <input type="text" name="proje_adi" placeholder="Proje Adı"
                                               class="form-control" value="{{ old('proje_adi') }}">
                                        <span class="text-danger">
                                    @error('proje_adi')
                                            {{ $message }}
                                            @enderror
                                ...
                                <div class="col-xl-12 col-md-12">
                                    <div>
                                        ...
                                        <input type="text" name="destek_alinan_kurum" placeholder="Destek Alınan Kurum"
                                               class="form-control" value="{{ old('destek_alinan_kurum') }}">
                                    </div>
                                </div>
                                <!--end col-->
                                <div class="col-xl-12 col-md-12">
                                    <div>
                                        ...
                                        <input type="text" name="cagri_tipi" placeholder="Çağrı Tipi Veya Kodu"
                                               class="form-control" value="{{ old('cagri_tipi') }}">
                                    </div>
                                </div>
                                <!--end col-->
                                <div class="col-xl-12 col-md-12">
                                    <div>
                                        ...
                                        <input type="text" name="proje_no" placeholder="Proje No"
                                               class="form-control" value="{{ old('proje_no') }}">
                                    </div>
                                </div>
                                <!--end col-->
                                <div class="col-xl-12 col-md-12">
                                    <div>
                                        ...
                                        <input type="text" name="proje_butcesi" placeholder="Proje Bütcesi"
                                               class="form-control" value="{{ old('proje_butcesi') }}">
                                    </div>
                                </div>
                                <!--end col-->
                                ...
                                <div class="col-xl-12 col-md-12">
                                    <div>
                                        ...
                                        <input type="text" name="arastirmacilar" placeholder="Araştırmacılar"
                                               class="form-control" value="{{ old('arastirmacilar') }}">
                                    </div>
                                </div>
                                <!--end col-->
                                <div class="col-xl-12 col-md-12">
                                    <div>
                                        ...
                                        <input type="text" name="proje_aciklama" placeholder="Projenin Kısa Açıklaması"
                                               class="form-control" value="{{ old('proje_aciklama') }}">
                                    </div>
                                </div>
                                <!--end col-->
                                <div class="col-xl-12 col-md-12">

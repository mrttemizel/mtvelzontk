        ...
        <div class="col-lg-12">
            ...
            <div class="card ">
                <div class="card-header align-items-center d-flex">
                    <h4 class="card-title mb-0 flex-grow-1">Etkinlik Ekle</h4>
                        ...
                        <div class="live-preview">
                            <div class="row gy-3">
                                ...
                                <div class="col-xl-12 col-md-12">
                                    <div>
                                        ...
                                        <input type="text" name="etkinlik_basligi" placeholder="Etkinlik Başlığı"
                                               class="form-control" value="{{ old('etkinlik_basligi') }}">
                                        <span class="text-danger">
                                ...
                                <div class="col-xl-12 col-md-12">
                                    <div>
                                        ...
                                        <input type="text" name="amac" placeholder="Amaç"
                                               class="form-control" value="{{ old('amac') }}">
                                    </div>
                                </div>
                                <!--end col-->
                                <div class="col-xl-12 col-md-12">
                                    <div>
                                        ...
                                        <input type="text" name="duzenleyen_birimi" placeholder="Düzenleyen Birim"
                                               class="form-control" value="{{ old('duzenleyen_birimi') }}">
                                    </div>
                                </div>
                                <!--end col-->
                                <div class="col-xl-12 col-md-12">
                                ...
                                <div class="col-xl-12 col-md-12">
                                    ...
                                    <div class="col-xl-12 col-md-12 mt-3">
                                        <div>
                                            <label for="formFile" class="form-label">Belge <span class="text-danger"> Yükleyebilceğiniz dosya tipleri <b>"pdf,xlsx,docx"</b>.</span></label>
